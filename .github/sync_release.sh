...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Vastar_MiSTer.git"
CORE_NAME=(Vastar)
...
UPSTREAM_CORE_NAME=(Vastar)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Vastar.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Vastar.rbf)
